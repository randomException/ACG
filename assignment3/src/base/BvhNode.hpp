...
struct Node
{
    ...
    void calculateStartAndEnd(FW::Vec3f& t_start, FW::Vec3f& t_end, const FW::Vec3f orig, const FW::Vec3f dir) const {
    ...
    FW::RaycastResult intersect_woop(const FW::Vec3f& orig, const FW::Vec3f& dir, std::vector<FW::RTTriangle>& triangles, FW::Vec3f old_t = std::numeric_limits<double>::infinity()) const {

        FW::RaycastResult castresult;

        FW::Vec3f t_start;
        FW::Vec3f t_end;
        calculateStartAndEnd(t_start, t_end, orig, dir);
        ...
        if (max(t_start) <= min(t_end)) {
            ...
            if (leftChild != nullptr && rightChild != nullptr) {
                ...
                /*FW::Vec3f t_start_right;
                FW::Vec3f t_end_right;
                rightChild->calculateStartAndEnd(t_start_right, t_end_right, orig, dir);*/
